function outputLabel = FaceRecognition_EIG_SVM(trainPath,testPath,data)
...
%% Train the SVM model
classifier = fitcecoc(projectedImg', labelImgSet, 'Coding', 'onevsall');
...
for i=1:size(testImgNames,1)
    ...
    outputLabel(i,:) = predict(classifier, projectedTestImg');
end
end
